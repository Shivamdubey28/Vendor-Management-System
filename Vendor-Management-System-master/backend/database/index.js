...
async function createPurchaseOrder({poNumber, vendor, orderDate, deliveryDate, expectedDeliveryDate, items, quantity, status, qualityRating, issueDate, acknowledgementDate}){
