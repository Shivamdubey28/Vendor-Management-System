        ...
        <Link to={to}>
            <div className="rounded-lg bg-slate-100 h-60 w-full p-8 shadow-lg drop-shadow-lg text-center hover:shadow-xl transition duration-300 transform hover:scale-110">
                ...
                <div className="w-full h-full flex justify-center items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 300 225" viewBox="0 0 300 225" className="w-2/3 h-2/3"
		...
		s40.32,11.44,66.82-15.05S261.4,107.77,261.4,107.77z"></path>
                            <g>
                                <path fill="#fff" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                                      stroke-miterlimit="10" stroke-width=".316" d="M136.78,130.82H31.08c-2.98,0-5.4-2.42-5.4-5.4V28.7c0-2.98,2.42-5.4,5.4-5.4h105.7c2.98,0,5.4,2.42,5.4,5.4
			v96.73C142.17,128.41,139.76,130.82,136.78,130.82z"></path>
                                <g>
                                    <g>
                                        <rect width="10.92" height="64.99" x="113.9" y="57.72" fill="#fff" stroke="#000"
                                              stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"
                                              stroke-width=".316"></rect>
                                        <rect width="10.92" height="29.27" x="90.28" y="93.45"></rect>
                                        <rect width="10.92" height="48.98" x="66.66" y="73.74" fill="#fff" stroke="#000"
                                              stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"
                                              stroke-width=".316"></rect>
					...
					c-0.39,0.47-1.05,0.62-1.61,0.37l-22.71-10L49.51,80.09C49.24,80.39,48.87,80.54,48.49,80.54z"></path>
                            ...
                            <g>
                                <path
                                    d="M222.8,90.27c0,0-6.54,29.01-24.55,43.54c0,0-7.55-6.06-6.94-42.68l15.21-2.86L222.8,90.27z"></path>
                                <polygon fill="#fff" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                                         stroke-miterlimit="10" stroke-width=".316"
                                         points="216.75 90.27 216.1 79.45 200.76 80.34 198.26 91.57 206.16 100.37"></polygon>
			...
			c6.36,2.77,17.27,1.81,20.04-4.56l24.24-53.82L180.23,91.57z"></path>
                                <path fill="#fff"
                                      d="M203.59,99.05l4.56,0.33v21.28c-2.18,6.22-9.22,14.87-9.22,14.87s-3.3-7.63-3.77-9.91L203.59,99.05z"></path>
			...
			c-6.5-1.3-16.16-4.13-21.98-4.28C222.8,90.27,211.08,119.45,199.05,132.04z"></path>
                                ...
                                <g>
                                    <path fill="#fff" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                                          stroke-miterlimit="10" stroke-width=".316"
                                          d="M178.55 204.18H97.52c-.84 0-1.59-.54-1.86-1.34L75.69 143.1c-.42-1.27.52-2.58 1.86-2.58h78.31c.84 0 1.59.54 1.86 1.34L178.55 204.18zM218.24 199.47h-41.26l1.86 4.71h42.45v-1.65C221.29 200.84 219.92 199.47 218.24 199.47z"></path>
                                </g>
                                <g>
                                    <path fill="#fff" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                                          stroke-miterlimit="10" stroke-width=".316"
                                          d="M214.2 169.77c0 0-14.28-7.43-28.37-6.36 0 0-6.14.96-.82 7.19 0 0-11.01 2.08-14.85 8.25-3.84 6.17 2.16 6.23 2.16 6.23l-2.59 4.51c-.95 1.66-.6 3.76.83 5.02l.12.11c1.04.92 2.59.95 3.68.09l0 0 0 0c-.58 1.52-.06 3.24 1.26 4.18l.06.04c1.28.91 3 .89 4.25-.07l.51-.39-.44 1.21c-.51 1.4-.01 2.98 1.23 3.82h0c1.17.8 2.73.75 3.85-.12l1.23-.95c0 0 4.92-6.37 13.16-4.06 1.88.53 3.87.61 5.79.26l1.69-.31c5.59-1.02 10.73-3.76 14.69-7.83l0 0 19.94-10.06-4.78-17.98L214.2 169.77zM185.01 170.6c0 0 5.8-1.8 11.99-.1"></path>
                                    <g>
			...
			C223.87,196.68,214.03,180.77,213.19,165.94"></path>
                                <path fill="none" stroke="#000" stroke-miterlimit="10" stroke-width=".316"
                                      d="M249.43,154.33l-35.72,11.61c0,0-0.96,13.37,10.68,30.73l17.72-6.79"></path>
                                <ellipse cx="221.51" cy="74.64" fill="#fff" stroke="#000" stroke-linecap="round"
                                         stroke-linejoin="round" stroke-miterlimit="10" stroke-width=".316" rx="4"
                                         ry="3.2" transform="rotate(-74.912 221.517 74.646)"></ellipse>
                                <g>
				...
				C222.67,76.92,222.53,77.06,222.35,77.06C222.35,77.06,222.35,77.06,222.35,77.06z"></path>
                                ...
                                <ellipse cx="194.46" cy="74.64" fill="#fff" stroke="#000" stroke-linecap="round"
                                         stroke-linejoin="round" stroke-miterlimit="10" stroke-width=".316" rx="3.2"
                                         ry="4" transform="rotate(-15.088 194.47 74.647)"></ellipse>
                                <g>
				...
				c-0.2,0.18-0.31,0.44-0.31,0.81C193.94,76.92,193.8,77.06,193.62,77.06z"></path>
                                ...
                                <path fill="#fff" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                                      stroke-miterlimit="10" stroke-width=".316" d="M195.81,66.27c0,0-1.21,21.67,11.74,21.95c14.01,0.3,12.62-21.95,12.62-21.95s-0.08-10.07-12.29-10.07
